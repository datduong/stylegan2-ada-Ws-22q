...
name_option = 'WS+22q11DS+Control+Normal+kimg10+target0.6+TransA+blankcenter' # ! name of how stylegan2 was trained
...
for fold in [0,1,2,3,4]: 
  ...
  for label1 in labelset: 
    ...
    #
    class1 = str(labelset_head_in_gan[label1]) + ',4' # start at 2y group
    class2 = str(labelset_head_in_gan[label1]) + ',6' # end at oldest group
    #
