...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    # ! added code
    EasyDict(name='fid100_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=100, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid200_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=200, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid500_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=500, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    EasyDict(name='fid800_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=800, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid1500_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=1500, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid2k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=2000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid3500_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=3500, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid20k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=20000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='fid40k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=40000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    ...
    # ! added code
    EasyDict(name='kid100_full',     class_name='metrics.kernel_inception_distance.KID',  max_reals=2000, num_fakes=100, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='kid800_full',     class_name='metrics.kernel_inception_distance.KID',  max_reals=16000, num_fakes=800, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
    EasyDict(name='kid2k_full',     class_name='metrics.kernel_inception_distance.KID',  max_reals=40000, num_fakes=2000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
